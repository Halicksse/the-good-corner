...
export type GetAllCategoriesAndUserInfoQuery = { __typename?: 'Query', getAllCategories: Array<{ __typename?: 'Category', id: number, title: string }>, getUserInfo: { __typename?: 'UserInfo', email?: string | null, isLoggedIn: boolean } };
